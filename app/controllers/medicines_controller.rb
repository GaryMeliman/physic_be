class MedicinesController < ApplicationController
  ...
  autocomplete :medicine, :nombre, { :display_value => 'nombre_con_cantidad', :full_model => true }
  ...
  private
    ...
    def medicine_params
      params.require(:medicine).permit(:nombre, :cantidad, :indicaciones, :laboratorio, :composicion, :posologia, :detalle, :efectos_colaterales, :contraendicaciones, :observaciones)
    end
end
